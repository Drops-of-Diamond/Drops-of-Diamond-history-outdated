...
Update 22 Feb 2017: my plans are to work on a stateless sharding implementation to integrate with Hera, eWASM and cppethereum. I decided not to go with Nimbus because an implementation developed with my current plan would be more performant.
